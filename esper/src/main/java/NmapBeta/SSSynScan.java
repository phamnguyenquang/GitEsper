...
public class SSSynScan {
	...
	public String getStatement() {
		String log2 = "select * from LogEventDev match_recognize("
				+ "measures A as LogEventDev1, B as LogEventDev2 pattern (A B) define A as A.message.contains('PROTO=TCP') and A.message.contains('SYN'), B as B.message.contains('PROTO=TCP')? and B.message.contains('ACK RST')?)";
		return log2;
	}
